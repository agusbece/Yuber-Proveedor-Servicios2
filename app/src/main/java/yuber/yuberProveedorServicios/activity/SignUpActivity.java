...
public class SignUpActivity extends AppCompatActivity {
    ...
    public static final String ServiciosOnSite = "serviciosOn-Site";
    ...
    public void cargarCombo(){
        ...
        client.get(null, url, new AsyncHttpResponseHandler(){
            ...
            public void onSuccess(String response) {
                ...
                editor.putString(ServiciosOnSite, response);
                editor.commit();
            }
            @Override
        ...
        String Response = sharedpreferences.getString(ServiciosOnSite, "");
    ...
    public void signup() {
        ...
        ClavePrivada = "sk_test_I1hjprWh2InPxbdHJnh5p5AP";
        ClavePublica = "pk_test_tQTc8FTeFYq5ihMTvwmEpipu";
...
*/
    ...
    public boolean validate() {
        ...
        String ClavePrivada = "sk_test_VdJxKMK9bWopkP9J20CwKhJS";//clavePrivada.getText().toString();
        String ClavePublica = "pk_test_KCq958GzMIGBS0ojs5hh3AmW";//clavePublica.getText().toString();
